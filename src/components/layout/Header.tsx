...
const HomeIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24" className="w-6 h-6 shrink-0">
...
const ProfileIcon = ({ initial, pfpUrl }: { initial?: string; pfpUrl?: string }) => (
  pfpUrl ? (
    ...
    <div className="w-6 h-6 shrink-0 rounded-full bg-gradient-to-br from-[#8b5cf6] to-[#6366f1] flex items-center justify-center text-xs font-bold">
      {initial}
    </div>
  ) : (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24" className="w-6 h-6 shrink-0">
...
export function Header() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#09090b]/95 backdrop-blur border-t border-[#27272a] safe-area-bottom" style={{ maxHeight: '80px' }}>
